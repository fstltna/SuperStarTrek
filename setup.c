...
void prelim(void) {
	...
	prout("BBS Door Version 1.0.0 - Get it at the AmigaCity.xyz BBS");
	skip(1);
}
...
void freeze(int boss) {
	...
	for (zz = 0; zz <= 22; zz++)
	{
		if ((citem[zz] == '/') || (citem[zz] == '<') || (citem[zz] == '>') || (citem[zz] == '&') || (citem[zz] == '*') || (citem[zz] == '!') || (citem[zz] == '@') || (citem[zz] == '$') || (citem[zz] == '%') || (citem[zz] == '^') || (citem[zz] == '(') || (citem[zz] == ')') || (citem[zz] == '\'') || (citem[zz] == '"') || (citem[zz] == '\\') || (citem[zz] == '|') || (citem[zz] == '?') || (citem[zz] == '[') || (citem[zz] == ']') || (citem[zz] == '{') || (citem[zz] == '}') || (citem[zz] == '`') || (citem[zz] == '~') || (citem[zz] == '\t'))/* FOO */
		{
			citem[zz] = '_';
		}
	}
